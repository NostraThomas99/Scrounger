...
public unsafe partial class AutoGather
{
    private Item? EquipmentNeedingRepair()
    {
        ...
        var threshold = Scrounger.Config.DoRepair ? Scrounger.Config.RepairThreshold : defaultThreshold;
    ...
    private bool RepairIfNeeded()
    {
        ...
        if (!Scrounger.Config.DoRepair)
        {
            ChatPrinter.PrintError("Your gear is almost broken. Repair it before enabling Auto-Gather.");
